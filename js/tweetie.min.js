  ...
  f.fn.twittie = function (e, l) {
    ...
    var m = function (c) {
      ...
      q = function (g) {
        for (
          var d = c.template,
            a = "date tweet avatar url retweeted screen_name user_name".split(
              " "
            ),
            h = 0,
            b = a.length;
          ...
          d = d.replace(new RegExp("{{" + a[h] + "}}", "gi"), g[a[h]]);
        return d;
      };
          ...
          for (var d = 0; d < c.count; d++) {
            ...
            for (
              var h = a.user.name,
                ...
                k = c.dateFormat,
                f = c.dateFormat.match(/%[dmbByY]/g),
                e = 0,
                l = f.length;
              e < l;
              e++
            )
              k = k.replace(f[e], b[f[e]]);
            a = {
              user_name: h,
              date: k,
              tweet: a.retweeted
                ? m(
                    "RT @" + a.user.screen_name + ": " + a.retweeted_status.text
                  )
                : m(a.text),
